...
**The code here is the last EPPlus version under LGPL where the target framework has been changed to 2.0 instead of 3.5. Currently only EPPlus.dll (core) has been updated.**  
